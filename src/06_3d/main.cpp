...
int main()
{
    ...
    Shader outShader("./src/06_3d/shader/vertex.glsl", "./src/06_3d/shader/fragment.glsl");
    ...
    unsigned char *imageData = stbi_load("./src/06_3d/container.jpg", &width, &height, &nrChannels, 0);
    if (imageData)
    {
    ...
    while (!glfwWindowShouldClose(window))
	{
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, float(i + glfwGetTime()) * rotateSpeed, glm::vec3(1.0, 1.0, 1.0));
